export const slides = [
  ...
  },
  {
    ...
    "backgroundColor": "#F5F0E6",
    "pipelineSteps": [
      { "number": "1", "name": "Apply", "description": "Submit department sponsor, technical POC, audience, and data classification", "icon": "FileText", "color": "#006A96" },
      { "number": "2", "name": "Prototype", "description": "Build locally with Claude Code, Codex, or curated ITS templates via the TritonAI Developer API", "icon": "Code", "color": "#00629B" },
