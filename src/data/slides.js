export const slides = [
  ...
  },
  {
    ...
    "managerSummary": "Screen capture (1m48s, Sep 2026) of the TritonGPT AI Tutor being set up inside a Canvas course: choosing the teaching style, connecting Canvas pages and files as knowledge sources, and deploying the tutor. Source: 2026-09_TritonAIInstructionalPilot_v1.mp4, re-encoded for the deck.",
  ...
  },
  {
    ...
    "backgroundColor": "#F5F0E6",
    "managerLabel": "Class Planner metrics: daily usage, both planners",
      ...
      "peaks": [
        {
          ...
          "side": "right",
          "dy": -30,
          "text": "3.96k peak \u00b7 Jul 21\nJul 22 priority first pass"
        },
        {
          "series": 1,
          "date": "Sep 1",
  ...
  },
  {
    ...
    "type": "content",
    "content": [],
    "title": "Recently Developed Solutions: At Scale",
    "subtitle": "Seven built in the last year and now running campus-wide",
    "layout": "project-roster",
    "backgroundColor": "#F5F0E6",
  ...
  },
  {
    ...
    "roster": {
      ...
      "footnote": "A selection of recent work, not a full inventory. Every project runs on the same governed platform."
    },
    "claimNote": "Source: TritonAI program records and team knowledge vault \u00b7 a selection of recent work, not a full inventory \u00b7 reviewed Sep 22, 2026",
    "audiences": [
      "all",
  ...
  },
  {
    ...
    "roster": {
      "groups": [
        ...
        {
          "label": "Former SaaS partners · $219.4K total revenue · did not renew",
          "color": "#8A97A5",
          "columns": 2,
          "items": [
            {
